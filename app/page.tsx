    ...
    <>
      <main className="w-full h-full flex flex-col items-center justify-center pb-32 gap-24">
        ...
        >
          ...
          <p className="text-xl first-letter:ms-4">
            아케이드 게임에서 어디까지 갈 수 있는지 보여주는 기록, 아케이드
            게임을 플레이하면서 어떤 느낌이 들었는지 알려주는 리뷰, 아케이드에
            관한 자세한 모습을 사진으로 열람할 수 있는 갤러리 등등, 다양한
            아케이드 게임에 관한 경험을 전달해드리고 있습니다.
          </p>
        </Container>
          ...
          <UnorderedList>
            ...
            <li>
              <Link
                ...
                className="text-xl hover:text-hovering"
              >
                도돈파치 (1997): C-Shot - 원코인(노컨티뉴) 2-6 진출 및 1억점
                달성
              </Link>
            </li>
            <li>
