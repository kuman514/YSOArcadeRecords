...
export default async function GalleryPostLoadingPage() {
  return (
    <main className="w-full h-full max-w-3xl px-4 sm:px-8 py-32">
      <div className="fixed left-0 top-0 w-screen h-dvh bg-[rgba(0,0,0)] z-50 touch-none flex flex-col justify-center items-center sm:text-4xl text-white">
        <span className="animate-pulse">갤러리 이미지 로딩중...</span>
        <Link
