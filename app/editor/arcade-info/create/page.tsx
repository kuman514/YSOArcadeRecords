...
export const metadata: Metadata = {
  title: `아케이드 부문 생성 :: ${APP_NAME}`,
  description: '아케이드 부문을 새로 생성하는 곳',
};

export default async function CreateArcadeInfoPage() {
  ...
  return (
    <main className="w-full h-full max-w-3xl px-4 sm:px-8 py-32 flex flex-col gap-4">
      <h1 className="text-4xl font-bold">아케이드 부문 생성</h1>
      <ArcadeInfoForm />
    </main>
  );
}
