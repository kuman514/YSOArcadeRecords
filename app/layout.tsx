...
import SimplifiedSidebar from '^/src/features/sidebar/simplified';
...
export default async function RootLayout({ children }: Readonly<Props>) {
  ...
  return (
    <html lang="ko-kr">
      ...
      >
        <Header />
        <section className="w-full bg-background flex flex-row lg:grid lg:grid-cols-[4rem_1fr] min-h-[calc(100dvh-4rem)]">
